...
const SlideEduSupport = () => (
	<div className="carousel-item active animated slideInRight">
		...
		<div className="carousel-caption">
			...
			<p>From afterschool tutoring to project-based STEM programs (Science, TEchnology, Engineering, Math), Crosswalk Teen Center will reinforce the educational system with support and encouragement for teens.  We guide students into becoming increasingly more future-focused through college and career preparation programs and educational planning.</p>
		</div>
	</div>
);
...
const SlideConnections = () => (
	<div className="carousel-item animated slideInRight">
		...
		<div className="carousel-caption d-none d-md-block">
			<h6>Community Connections</h6>
			<p>Crosswalk Teen CEnter believes students dont just live in a community, but they are part of a community.  Teen committees organize and carry out a wide variety of commuinity projects and partner with local organizations to make our community better.</p>
		</div>
	</div>
);
